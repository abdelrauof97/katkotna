...
<div id="customer_login">
	...
	<h1>
		<a href="#" class="tab-header<?php if ( ! $is_register_form ) { ?> active<?php } ?>" data-tab-class="login-wrap"><?php esc_html_e( 'Login', 'woocommerce' ); ?></a><?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) { ?> /
			<a href="#" class="tab-header<?php if ( $is_register_form ) { ?> active<?php } ?>" data-tab-class="register-wrap"><?php esc_html_e( 'Register', 'woocommerce' ); ?></a><?php } ?>
	</h1>

	<ul class="wrap">
		<li class="login-wrap<?php if ( ! $is_register_form ) { ?> active<?php } ?>">
		...
		<li class="register-wrap<?php if ( $is_register_form ) { ?> active<?php } ?>">
