	...
	<?php if ( $order ) :
		...
		<?php else : ?>
			...
			<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received">
				...
				<br>
				<svg>
					<use xlink:href="<?php echo esc_url( ideapark_svg_url() ); ?>#svg-check-light" />
				</svg>
				<br>
			...
			<ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details">
				...
				<li class="woocommerce-order-overview__order order">
					...
					<strong><?php echo ideapark_wrap( $order->get_order_number() ); ?></strong>
				</li>
				...
				<?php if ( is_user_logged_in() && $order->get_user_id() === get_current_user_id() && $order->get_billing_email() ) : ?>
					<li class="woocommerce-order-overview__email email">
						...
						<strong><?php echo ideapark_wrap( $order->get_billing_email() ); ?></strong>
					</li>
				<?php endif; ?>

				<li class="woocommerce-order-overview__total total">
					<?php esc_html_e( 'Total:', 'woocommerce' ); ?>
					<strong><?php echo ideapark_wrap( $order->get_formatted_order_total() ); ?></strong>
				</li>
		...
		<div class="woocommerce-thankyou-order-wrap">
