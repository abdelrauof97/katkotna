...
<form id="order_review" method="post">
	<div class="row">
		<div class="col-md-8">
			<table class="shop_table shop_table--pay">
				<thead>
				<tr>
				...
				<?php if ( count( $order->get_items() ) > 0 ) : ?>
					<?php foreach ( $order->get_items() as $item_id => $item ) : ?>
						...
						<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
							...
							<td class="product-subtotal"><?php echo ideapark_wrap( $order->get_formatted_line_subtotal( $item ) ); ?></td><?php // @codingStandardsIgnoreLine ?>
						</tr>
					<?php endforeach; ?>
				<?php endif; ?>
				</tbody>
				...
				<?php if ( $totals ) : ?>
					<?php foreach ( $totals as $total ) : ?>
						<tr>
							<th scope="row"
								colspan="2"><?php echo ideapark_wrap( $total['label'] ); ?></th><?php // @codingStandardsIgnoreLine ?>
							<td class="product-total"><?php echo ideapark_wrap( $total['value'] ); ?></td><?php // @codingStandardsIgnoreLine ?>
						</tr>
					<?php endforeach; ?>
				<?php endif; ?>
				</tfoot>
		...
		<div class="col-md-4">
			<div class="collaterals checkout-collaterals checkout-collaterals--pay">
				<div id="payment">
