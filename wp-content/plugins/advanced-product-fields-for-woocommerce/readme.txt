...
= 1.6.21 =
 * Fix: fixed fields not appearing at cart when dealing with variable products.

= 1.6.20 =
 * Improvement: added minor extra security improvements.
 ...
 * Other: verify WP 6.9 and Woo 10.4 compatibility.
...
= 1.6.14 =
 * Improvement: better integration with theme builders who don't adhere to Woo standards.
